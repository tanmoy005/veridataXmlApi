...
namespace VERIDATA.Model.Table.Public
{
    ...
    public class UnProcessedFileData
    {
        ...
        [Column("unprocessed_id", TypeName = DbDataType._biginteger)]
        public int UnProcessedId { get; set; }
        ...
        [Column("reason_to_unprocess", TypeName = DbDataType._textmax)]
        public string? UnprocessReason { get; set; }
