CREATE TABLE [dbo].[appointee_details] (
    ...
    [is_dual_employement]    BIT             NULL,
    [account_no]             NVARCHAR (50)   NULL,
    [ifsc_code]              NVARCHAR (50)   NULL,
    [is_bankvarified]        BIT             NULL,
    [is_policevarified]      BIT             NULL,
    [fir_details]            NVARCHAR (MAX)  NULL,
    [is_dlvarified]          BIT             NULL,
    [driving_license]        NVARCHAR (50)   NULL,
    [has_drivinglicense]     BIT             NULL,
    [has_pan]                BIT             NULL,
