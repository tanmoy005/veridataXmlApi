CREATE TABLE [dbo].[raw_file_data] (
    ...
    CONSTRAINT [PK_raw_file_data] PRIMARY KEY CLUSTERED ([rawfile_id] ASC),
    CONSTRAINT [FK_raw_file_data_company_company_id1] FOREIGN KEY ([company_id1]) REFERENCES [admin].[company] ([company_id]),
    CONSTRAINT [FK_raw_file_data_uploaded_xls_file_file_id1] FOREIGN KEY ([file_id1]) REFERENCES [dbo].[uploaded_xls_file] ([file_id])
);
